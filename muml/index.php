...
<html>
	<head>
		...
		<title>Brand In Action | Manchester United</title>
	...
	<body style="background-image: url(../img/muml-header-green.jpg)">
		...
		<div class="wrapper">
			<div class="muml-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="How We Help Manchester United to Sell Itself." src="../img/muml-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="muml-1">
				<div class="panel-content">
					...
					<p>You might think the world’s most valuable sporting brand wouldn’t need to work too hard, when selling. Manchester United’s global awareness is almost universal. The brand doesn’t have consumers – it has fans, and in many retail situations, it is partnered with Nike!</p>
					<p>But with international fame come problems.</p>
				</div>	
			</div>
			<div class="muml-2">
				<div class="panel-content">
					<div class="padding-top-fix">
						<img src="../img/the-story-spacer.gif">
					</div>	
					<p>Facts, figures and messages can subtly change over long distances. When many people are doing the selling (to stores, investors, partners or potential sponsors), there’s a risk of ending up with many different versions of the pitch. Confusion, inaccuracy and missed opportunities can result.</p>
				</div>		
			</div>
			<div class="muml-3">
				<div class="panel-content">
					<h1>One version of the truth</h1>
					<p>What’s needed is one version of the truth, accessible to all and easy to use in real-world selling situations. This was the brief to Brand In Action from MUML, Manchester United’s marketing and merchandising arm. In response, we developed the Sales Toolkit.</p>
					<div class="full-width">
						<img src="../img/muml-1.jpg">
					</div>
					<p>This is a digital database and content management system, accessed via an attractive interface that is designed to support all of MUML’s selling activities.</p>
				</div>
			</div>
			<div class="muml-4">
				<div class="panel-content">
					<h1>Soccer Schools, licensing and Megastores</h1>
					<p>The Toolkit is in three parts, with resources for the licensing department; Soccer Schools; and retail negotiators, whose task is to find partners and set up MU Megastores around the world.</p>
					<p>The Manchester United story in facts, figures and video is prominent, of course. The Toolkit also contains product range details, licensee agreements, details of the support on offer and case studies that show how lucrative a relationship with Manchester United can be.</p>
					<div class="full-width">
						<img src="../img/muml-2.jpg">
					</div>	
				</div>
			</div>
			<div class="muml-5">
				<div class="panel-content">
					<div class="full-width">
						<img alt="How We Do It" src="../img/muml-3.jpg">
					</div>
					<p>Sales negotiators can create bespoke presentations from the Toolkit’s content, changing slides, sequences and languages in seconds. They can print presentations to leave behind. And they can do this all from their laptop or tablet, knowing that every piece of information, image, slide or statistic is totally accurate and completely up-to-date.</p>	
				</div>
			</div>
			<div class="muml-6">
				<div class="panel-content">
					<h1>Easy and effective</h1>
					<p>The Toolkit has transformed the way MUML sells. Its ease of use has gained rapid acceptance by salespeople around the world, and its comprehensive content has improved the professionalism and effectiveness of every sales encounter.</p>
				</div>
			</div>
