...
<html>
	...
	<body style="background-image: url(../img/kuhmo-hall-of-fame-header-green.jpg)">
		...
		<div class="wrapper">
			<div class="kuhmo-hall-of-fame-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="Building A Brand. Where Lewis Hamilton Learned his Craft" src="../img/kuhmo-hall-of-fame-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="kuhmo-hall-of-fame-1">
				<div class="panel-content">
					<img alt="The Story" src="../img/the-story.svg">
					<p>Every year, the Netherlands' famous Zandvoort racing circuit is host to a very important motor race. No, not a Formula 1 Grand Prix, but the international final of Formula 3 – known as the Masters of Formula 3.</p>

					<p>Why is it important? Because it’s motor racing’s crystal ball.</p>

					<p>Young drivers, who perhaps cut their teeth on karts or Formula Ford just a season or two ago, have now graduated to F3 cars and the ones who do well in national heats race annually at Zandvoort for the global F3 crown.</p>
				</div>	
			</div>
			<div class="kuhmo-hall-of-fame-2">
				<div class="panel-content">
					<div class="padding-top-fix">
						<img alt="The Story" src="../img/the-story-spacer.gif">
					</div>	
					<p>In 2005, Lewis Hamilton was the winner. Rubens Barrichello did well in 1994 and David Coulthard carried off the trophy in 1991.</p>

					<p>All the cars in a Masters of Formula 3 race run on Kumho Tyres, a fact that is known to F3 aficionados but not necessarily to the general motoring public.</p>

					<p>Kumho asked us to help rectify this omission at the circuit, at UK tyre dealers, and to customers and prospects of Kumho’s ECSTA network of specialist performance tyre outlets.</p>

					<p>Our response was an integrated campaign of advertising, promotions, hospitality work and trackside corporate branding.</p>
				</div>		
			</div>
			<div class="kuhmo-hall-of-fame-3">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/kuhmo-hall-of-fame-1.jpg">
					</div>	
				</div>
			</div>
			<div class="kuhmo-hall-of-fame-4">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/kuhmo-hall-of-fame-2.jpg">
					</div>	
				</div>
			</div>
			<div class="kuhmo-hall-of-fame-5">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/kuhmo-hall-of-fame-3.jpg">
					</div>
					<p>One manifestation was a Hall of Fame souvenir brochure that showed the many household names that reached the top via F3 and with the help of Kumho tyres.</p>
				</div>
			</div>
			<div class="kuhmo-hall-of-fame-6">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/kuhmo-hall-of-fame-4.jpg">
					</div>	
				</div>
			</div>
			<div class="kuhmo-hall-of-fame-7">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/kuhmo-hall-of-fame-5.jpg">
					</div>	
				</div>
			</div>
			<div class="kuhmo-hall-of-fame-8">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/kuhmo-hall-of-fame-6.jpg">
					</div>	
				</div>
			</div>
			<div class="kuhmo-hall-of-fame-9">
				<div class="panel-content">
					<p>Our ads exploited the link between Lewis Hamilton’s success and the superiority of Kumho’s high performance road tyres.</p>
					<p>Our trackside branding took the Kumho performance message to up to 100,000 fans who line the Zandvoort circuit every year.</p>
					<p>And our promotional activities and posters helped Kumho tyre dealers to capitalise on the brand’s performance connection to the benefit of sales.</p>
					<p><b>A winning formula, you might say.</b></p>
				</div>
			</div>	
