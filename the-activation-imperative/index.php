...
<html>
	<head>
		...
		<title>Brand In Action | The Activation Imperative</title>
	...
	<body style="background-image: url(../img/the-activation-imperative-header-green.jpg)">
							...
							<div class="menu-links">
								<ul>
									<li>
										...
										<a href="/the-activation-imperative/">Putting the Gordon’s in G&amp;T<br></a>
		...
		<div class="wrapper">
			<div class="the-activation-imperative-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="‘The Activation Imperative’ An in-depth study of sponsorship activation in the Premier League." src="../img/the-activation-imperative-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="the-activation-imperative-1">
				<div class="panel-content">
					<img alt="The Story" src="../img/the-story.svg">	
					<p>In this paper, Brand in Action publishes the results from a series of in-depth interviews conducted with some of the key figures in football club sponsorship, including partnership managers at eight Premier League clubs of different sizes and profiles.</p>
					<h3>We reveal...</h3>
					<ul>
						<li>The absence of activation from sponsorship sales negotiations</li>
						<li>Why a strategic approach is vital</li>
						<li>How activation can bring fans closer to brands</li>
						<li>Why content is still king</li>
						<li>How the wrong resource can hamper activation</li>
						<li>The importance of measuring activity</li>
						<li>What good looks like – brilliant activation campaigns</li>
					</ul>
				</div>	
			</div>

			<a class="anchor-link" id="perch-reset"></a>
			<div class="activation-signup">
				<div class="panel-content">
					<div class="contact-form">
						<?php perch_content('Activation Imperative Signup'); ?>
					</div>
					<div class="social">
						<a href="https://www.linkedin.com/company/brand-in-action?trk=company_name" target="blank">
							<div class="linkedin" alt="LinkedIn">
