...
<html>
	<head>
		...
		<title>Brand In Action | Hublot</title>
	...
	<body style="background-image: url(../img/hublot-header-green.jpg)">
		...
		<div class="wrapper">
			<div class="hublot-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="Brand In Action's Split-Second Timing for Hiblot Watches" src="../img/hublot-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="hublot-1">
				<div class="panel-content">
					...
					<p>Hublot is the chronometer and timepiece division of the luxury brand stable LVMH. The brand was Manchester United’s official watch partner until Sir Alex Ferguson retired.</p>
				</div>	
			</div>
			<div class="hublot-2">
				<div class="panel-content">
					...
					<p>On the day that Manchester United won the Premier League trophy, Hublot asked us to produce a souvenir brochure to be handed out at the Player of the Year Awards dinner, which was to be held the following evening.</p>

					<p>In 24 hours, then, we were tasked with developing the concept and the design, taking a team photograph in the Manchester United dressing room, creating artwork and delivering the final, printed item to VIP guests at the event.</p>
				</div>		
			</div>
			<div class="hublot-3">
				<div class="panel-content">
					...
					<p>The result was a highly polished piece of work that perfectly represented the quality and exclusivity of the Hublot brand, while also demonstrating its energy and mastery of time.</p>
					<p>As you can see, the brochure’s title was ‘Cometh the Hour, Cometh the Man’. You could also say ‘Cometh the rush-job, Cometh Brand In Action’!</p>
				</div>
			</div>
