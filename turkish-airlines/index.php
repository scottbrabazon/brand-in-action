...
<html>
	<head>
		...
		<title>Brand In Action | Turkish Airlines</title>
	...
	<body style="background-image: url(../img/turkish-airlines-header-green.jpg)">
		...
		<div class="wrapper">
			<div class="turkish-airlines-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="How Turkish Airlines Took a Piece of Old Trafford Around the World" src="../img/turkish-airlines-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="turkish-airlines-1">
				<div class="panel-content">
					<img src="../img/the-story.svg">
					<p>Most Manchester United fans would probably say the most iconic part of Old Trafford is the team tunnel.<p>
					<p>There’s little to compare with the roar that erupts when the teams emerge onto the pitch. To walk that tunnel, treading the same turf as Rooney, Giggs and Charlton is a lifetime’s ambition for thousands of fans worldwide.</p>	
				</div>	
			</div>
			<div class="turkish-airlines-2">
				<div class="panel-content">
					<h1>An Unforgettable<br>Photo Op</h1>
					<p>So when Turkish Airlines asked us for a way to announce and exploit their sponsorship to potential customers at international hub airports, we suggested a life-sized team tunnel, complete with legendary players and a realistic Old Trafford crowd-scene, so that travellers and fans all over the world could have their photos taken on a perfect replica of sporting hallowed ground.</p>
					<p>As it happened, this was the year Manchester United won the Premier League Trophy, so fans were able to actually hold that precious cup while standing with life-sized images of their heroes.</p>		
				</div>	
			</div>
			<div class="turkish-airlines-3">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/turkish-airlines-1.jpg">
					</div>	
				</div>
			</div>
			<div class="turkish-airlines-4">
				<div class="panel-content">
					<h1>Message delivered, <br>brand enlivened</h1>
					<p>Did anyone passing through Turkish Airlines’ international hubs fail to get the message that the airline was now partnering the world’s biggest sports brand? We think not.</p>
					<p>Did thousands of football fans around the world see Turkish Airlines in a whole new light? Absolutely.</p>
				</div>	
			</div>
			<div class="turkish-airlines-5">
				<div class="panel-content">
					<div class="padding-top-fix">
						<h1>&nbsp;<br>&nbsp;</h1>
					</div>	
					<p>Are some of those fans and their children tempted to tell a white lie about where their treasured photos were really taken?</p>
					<p>We couldn’t possibly comment, though it has been said that standing in our travelling tunnel was just like being there.</p>
				</div>		
			</div>
