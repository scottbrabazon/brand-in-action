...
<head>
	<meta charset="utf-8">
	<title>Brand in Action | What We Have to Say</title>
...
<body style="background-image: url(../img/blog-red-header.jpg)">
	...
	<div class="wrapper">
		...
		<div class="blog-header">
			<div class="panel-content">
				<div class="graphic-header">
					<img alt="What We Have to Say" src="../img/blog-header-graphic.svg">
				</div>	
			</div>	
		</div>	
		...
		<div class="blog-index">
			<div class="primary-content">
				<?php perch_blog_recent_posts(4);?>
				<div class="more-posts">
					<div class="panel-content">
					    <h2><u><a href="archive.php">More posts</a></u></h2>
					</div>
				</div>
			</div>
		</div>	
