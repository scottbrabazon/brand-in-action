...
<html>
	<head>
		...
		<title>Brand In Action | DHL</title>
	...
	<body style="background-image: url(../img/dhl-header-green.jpg)">
		...
		<div class="wrapper">
			<div class="dhl-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="Marking A Memorable Event For International VIP's" src="../img/dhl-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="dhl-1">
				<div class="panel-content">
					...
					<p>As a global business and Manchester United sponsor, DHL bring important guests from all over the world to matches at Old Trafford.</p>
					<p>It’s a big deal, watching a game from a VIP box and, the team being who they are, the action on the pitch is usually memorable.</p>
					<p>But DHL wanted to go further, with something unique and precious that they could give their guests as a memento of the time they witnessed greatness at the Theatre of Dreams.</p>
				</div>	
			</div>
			<div class="dhl-2">
				<div class="panel-content">
					...
					<p>We responded to this brief with an idea – let’s match the special feeling in the ground with limited edition prints of rare action photographs, showing special players from Manchester United’s past.</p>
					<p>In collaboration with the club, we settled on Bryan Robson, Denis Law, Denis Irwin and, of course, Sir Bobby Charlton as the icons to feature.</p>
					<p>The images were sourced, printed on high quality paper, then beautifully framed and presented as a gift from DHL.</p>
				</div>		
			</div>	
			<div class="dhl-3">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/dhl-delivering-a-gift.jpg">
					</div>	
				</div>
			</div>
			<div class="dhl-4">
				<div class="panel-content">
					<p>They are always well received, of course, and can be seen on office and boardroom walls around the world, prized as unique mementoes by DHL’s clients and special guests.</p>
					<p>Indeed, they have become so collectable that DHL’s global CEO now uses them as personal gifts when travelling the world!</p>
				</div>
			</div>	
			<div class="contact-us-mobile">
				<div class="panel-content">
					<img src="../img/contact-us-green-wo.svg">
			...
			<div class="contact-us">
				...
				<div class="panel-content">
					<img src="../img/contact-us-green.svg">
					<p>We’d love to talk about ideas, events, campaigns or installations that will engage your audiences and deliver value for your sponsorship investments.</p>
					<p><strong>Brand in Action</strong><br>
					The Foundry Communications Ltd<br>
					3 Denmark Street<br>
