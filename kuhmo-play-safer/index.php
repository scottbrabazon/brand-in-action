...
<html>
	<head>
		...
		<title>Brand In Action | Kuhmo Tyre</title>
	...
	<body style="background-image: url(../img/kuhmo-play-safer-header-green.jpg)">
		...
		<div class="wrapper">
			<div class="kuhmo-play-safer-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="Kicking Kuhmo Tyres Into the Premier League (With a Little Help From Sir Bobby Charlton" src="../img/kuhmo-play-safer-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="kuhmo-play-safer-1">
				<div class="panel-content">
					<img alt="The Story" src="../img/the-story.svg">	
					<p>Korean tyre brand Kumho is one of the world’s top 10 manufacturers, but is not well known in the UK and Europe.</p>

					<p>When they asked Brand In Action to develop a differentiating brand proposition, we decided to step away from the cold, crowded technical/performance territory fought over by the other brands and develop a warmer, more human face:</p>

					<p>Kumho – Making a difference. And when Kumho became a Manchester United sponsor, they asked us to help exploit their sports expenditure in the context of this new brand position.</p>
				</div>	
			</div>
			<div class="kuhmo-play-safer-2">
				<div class="panel-content">
					<p>One result was Play Safer, a cycling road safety programme delivered to schoolkids, their parents and teachers by Kumho, in association with the Manchester United Foundation, Greater Manchester Police, Sir Bobby Charlton, Denis Irwin, Andrew Cole, Darren Fletcher, Wes Brown and other Manchester United legends (even Fred the Red!).</p>
					<div class="full-width">
						<img src="../img/kuhmo-play-safer-1.jpg">
					</div>	
				</div>
			</div>
			<div class="kuhmo-play-safer-3">
				<div class="panel-content">
					<h1>Tyres at Old Trafford</h1>
					<div class="full-width">
						<img src="../img/kuhmo-play-safer-2.jpg">
					</div>
				</div>
			</div>
			<div class="kuhmo-play-safer-4">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/kuhmo-play-safer-3.png">
					</div>	
				</div>
			</div>
			<div class="kuhmo-play-safer-5">
				<div class="panel-content">
					<p>The programme launched at Old Trafford itself, in front of 75,000 fans, where hundreds of kids and their dads honed soccer skills and road safety awareness, while also having loads of fun.</p>
					<div class="full-width">
						<img src="../img/kuhmo-play-safer-4.png">
					</div>	
				</div>
			</div>
			<div class="kuhmo-play-safer-6">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/kuhmo-play-safer-5.png">
					</div>	
				</div>
			</div>
			<div class="kuhmo-play-safer-7">
				<div class="panel-content">
					<div class="full-width">
						<img alt="How We Do It" src="../img/kuhmo-play-safer-6.jpg">
					</div>	
				</div>
			</div>
			<div class="kuhmo-play-safer-8">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/kuhmo-play-safer-7.png">
					</div>	
				</div>
			</div>
			<div class="kuhmo-play-safer-9">
				<div class="panel-content">
					<p>They entered the event through the Kumho arch, dribbled the ball through Kumho tyres, learned about situational awareness and safe crossing, then took away Kumho branded T-shirts, skills cards and an official certificate (picturing their favourite soccer stars, of course).</p>
					<div class="full-width">
						<img src="../img/kuhmo-play-safer-8.jpg">
					</div>	
				</div>
			</div>
			<div class="kuhmo-play-safer-10">
				<div class="panel-content">
					<h1>162%, 58 million<br>and other<br>great results</h1>
					<p>The event then rolled out to local schools, where interest and excitement were intense. Press and TV coverage was widespread, delivering 58 million opportunities to see. Kumho website visits were up 162% and people from 84 countries downloaded 1,478 jointly-branded skills cards and other souvenirs. There were almost 7,000 entries to the Play Safer competition.</p>
				</div>	
			</div>
			<div class="kuhmo-play-safer-11">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/kuhmo-play-safer-9.jpg">
					</div>
				</div>		
			</div>	
			<div class="kuhmo-play-safer-12">
				<div class="panel-content">
					<h1>The Long Game</h1>
					
					<p>Play Safer engaged thousands of kids and their parents, watched by tens of thousands of soccer fans, and delivered enormous value from Kumho’s Manchester United sponsorship within the differentiating social context of the brand proposition.</p>
				</div>	
			</div>
			<div class="kuhmo-play-safer-13">
				<div class="panel-content">
					<div class="padding-top-fix">
						<h1>&nbsp;</h1>
					</div>	
					<p>Says John Thrupp, Marketing Director, Kumho Tyre UK:</p>

					<p>“Although Kumho is interested in selling tyres today, we’re playing a long game, too, building and improving perceptions of our brand so that tomorrow’s sales are easier to make.</p>

					<p>Will Play Safer double our sales next week? Of course not. Will it eventually make Kumho mean more than black rubber around your wheels? Absolutely!”</p>
				</div>
			</div>	
