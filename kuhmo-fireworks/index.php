...
<html>
	<head>
		...
		<title>Brand In Action | Kuhmo Tyre | Half Time Firework Display</title>
	...
	<body style="background-image: url(../img/kuhmo-fireworks-header-green.jpg)">
		...
		<div class="wrapper">
			<div class="kuhmo-fireworks-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="Fireworks at Old Trafford on Kuhmo's 50th Birthday" src="../img/kuhmo-fireworks-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="kuhmo-fireworks-1">
				<div class="panel-content">
					<img alt="The Story" src="../img/the-story.svg">
					<p>Kumho Tyre, Korean tyre brand and Manchester United Platinum Sponsor, couldn’t have asked for more – sole sponsorship of an important evening match that coincided with the brand’s 50th birthday and resulted in a 2-0 win against Spurs!</p>

					<p>Brand in Action helped Kumho exploit the game with an unforgettable weekend for 120 of Kumho’s international guests, plus a spectacular half-time celebration for tens of thousands of fans.</p>
				</div>	
			</div>
			<div class="kuhmo-fireworks-2">
				<div class="panel-content">
					<div class="padding-top-fix">
						<img src="../img/the-story-spacer.gif">
					</div>	
					<p>A fleet of buses (all shod with Kumho Tyres, of course) collected the VIPs from Manchester Airport and took them to their luxury city centre hotel, chosen for its proximity to the Football Museum.</p>

					<p>A private visit to the museum was followed by the transfer to Old Trafford, where the guests took their seats for the big match.</p>

					<p>The atmosphere was electrifying, of course – most of the guests had never visited The Theatre of Dreams before – and the match would have been memorable, even without the half-time surprise...</p>
				</div>		
			</div>
			<div class="kuhmo-fireworks-3">
				<div class="panel-content">
					<h1>The biggest-ever on-pitch firework display</h1>
					<p>A large group of gymnasts ran onto the field in procession, some splitting off to take station at the corners of the pitch. Escala’s dramatic electric strings version of Led Zeppelin’s <i>Kashmir</i> swelled to fill the stadium - and Manchester United’s biggest-ever on-pitch firework display formed a blazing backdrop to a stunning Korean dance and athletic routine.</p>
					<div class="container">
					<iframe src="http://www.youtube.com/embed/yoV7qYNa8V8?showinfo=0&modestbranding=1&autohide=1&rel=0" 
					frameborder="0" allowfullscreen class="video"></iframe>
					</div>
					<p>The VIPs were transfixed - and even the fans (most of whom usually pay little attention to half-time diversions) watched and cheered as the event reached its spectacular climax, with fireworks on the roof of the stands as well as on the pitch.</p>
				</div>
			</div>
			<div class="kuhmo-fireworks-4">
				<div class="panel-content">
					<h1>“Breathtaking”</h1>
					<p>The response was overwhelmingly positive, drawing comments such as “breathtaking”, “stunning” and “amazing” from fans, and boosting awareness and positive perceptions of Kumho tyres in the minds of over 75,000 potential consumers.</p>
				</div>
			</div>
