...
<html>
	<head>
		...
		<title>Brand In Action | Swissquote</title>
	...
	<body style="background-image: url(../img/swissquote-header-green.jpg)">
		...
		<div class="wrapper">
			<div class="swissquote-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="A New Game For A New Name" src="../img/swissquote-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="swissquote-1">
				<div class="panel-content">
					<img alt="The Story" src="../img/the-story.svg">
					<p>Swissquote is Switzerland’s premier online bank, but a new name on the UK financial services scene. Using their secure online services, you can carry out leveraged trading in currencies, commodities and share indices.</p>
					<p>They have partnered with Manchester United to build brand awareness in an audience who, like Swissquote itself, aims for success.</p>
					<p>As Swissquote say: “YOU are our star player”.</p>
				</div>	
			</div>
			<div class="swissquote-2">
				<div class="panel-content">
					<h1>The Footgolf Challenge</h1>
					<p>Recently, the company arranged a golfing tournament with a difference. Four Manchester United squad stars – Juan Mata, Ander Herrera, Jonny Evans and Chris Smalling – battled it out in the inaugural Swissquote Forex Footgolf Challenge.</p>
					<p>Yes, Footgolf. Golf, with a football, no golf club and very big holes.</p>
					<p>Swissquote asked Brand In Action to use this new game as the theme for a match-day event at Old Trafford, to engage and entertain fans while raising awareness and collecting data for future email programmes.</p>
					<p>So we built the world’s first Footgolf practice ramp and offered a signed Manchester United shirt as the draw prize for fans who managed to score at least one hole in the three attempts they were allowed.</p>
				</div>		
			</div>
			<div class="swissquote-3">
				<div class="panel-content">
					<div class="container">
					<iframe src="http://www.youtube.com/embed/SVn125iE08E?showinfo=0&modestbranding=1&autohide=1&rel=0" 
					frameborder="0" allowfullscreen class="video"></iframe>
					</div>
				</div>
			</div>
			<div class="swissquote-4">
				<div class="panel-content">
					<h1>Queuing around the block</h1>
					<p>Named ‘Can you score a goal in one?’, the event was a huge success, with hundreds of fans queuing to take part and great excitement every time the ball went into the hole.</p>
					<p>Swissquote’s objectives were certainly achieved, with data gathered from hundreds of prospects and awareness of the new bank significantly boosted on the day.</p>
				</div>
			</div>
