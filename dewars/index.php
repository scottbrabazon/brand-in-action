...
<html>
	<head>
		...
		<title>Brand In Action | Dewar's</title>
	...
	<body style="background-image: url(../img/dewars-header-green.jpg)">
		...
		<div class="wrapper">
			<div class="dewars-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="Coming to America – Bringing Tommy Dewar" src="../img/dewars-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="dewars-1">
				<div class="panel-content">
					...
					<p>Dewar’s White Label is the USA’s No.1 blended whisky and has been for a century or so, ever since Tommy Dewar, the distillery’s founder, barnstormed across the nation at the beginning of the 20th century.</p>
					<p>To celebrate this, on the brand’s 150th anniversary, Brand In Action brought the 19th century character back to life in a travelling exhibition that told his story, followed his route and packed up into its own steamer trunks for transport from point to point.</p>
				</div>
			</div>
			<div class="dewars-3">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/dewars-1.jpg">
					</div>	
				</div>
			</div>
			<div class="dewars-2">
				<div class="panel-content">
					<h1>Exploits and ebullience</h1>
					<p>Tommy Dewar was a larger-than-life character and a powerful personification of his brand – think of a Victorian Richard Branson. His exploits, ebullience and pithy sayings (they were known as Dewarisms and considered quite outrageous at the time) made the papers everywhere he went, to the great benefit of the fine tipple he was selling.</p>
					<div class="container">
						<iframe src="https://www.youtube.com/embed/ujAqNdSiitQ?showinfo=0&modestbranding=1&autohide=1&rel=0"
						frameborder="0" allowfullscreen class="video"></iframe>
					</div>
					<p>His foresight led to Dewar’s being one of the first-ever brands to use moving pictures for publicity – and the exhibition showed the fragments that remain of this pioneering commercial, along with many Dewarisms, historic news reports of his exploits and sales souvenirs of the time.</p>
					<div class="full-width">
						<img alt="How We Do It" src="../img/dewars-2.jpg">
					</div>	
				</div>
			</div>
			<div class="dewars-3">
				<div class="panel-content">
					<div class="container">
						<iframe src="https://www.youtube.com/embed/bWKUNxfuSpY?showinfo=0&modestbranding=1&autohide=1&rel=0"
						frameborder="0" allowfullscreen class="video"></iframe>
					</div>
					<div class="full-width">
						<img src="../img/dewars-3.jpg">
					</div>	
				</div>
			</div>
			<div class="dewars-4">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/dewars-4.jpg">
					</div>
				</div>
			</div>
			<div class="dewars-5">
				<div class="panel-content">
					<h1>Awards and effectiveness</h1>
					<p>The exhibition was one part of Brand In Action's global anniversary campaign for the brand. This included a multi-award winning website (the BT Superhighway Award for effectiveness and creativity was particularly welcome), a limited-edition bottle, celebration memorabilia and a replica of Tommy Dewar’s personal notebook that was given to VIP whisky retailers.</p>
					<div class="full-width">
						<img src="../img/dewars-5.jpg">
					</div>	
				</div>
			</div>
			<div class="dewars-6">
				<div class="panel-content">
					<div class="full-width">
						<img alt="How We Do It" src="../img/dewars-6.jpg">
					</div>
					<p>Incidentally, we’re pretty sure Tommy himself would have been pleased with our efforts – his notebook appeared in the D&amp;AD annual that year, with writing credited to T. Dewar, of course!
					<h1>Some Dewarisms</h1>
					<p>“Respectability is the state of never being caught doing anything that gives you pleasure.”<br>
					“If we are here to help others, I often wonder what the others are here for?”<br>
					“There’s no fun like work!”<br>
					“Two words at the altar and you are married. A few words in your sleep and you are divorced!”</p>
				</div>
			</div>			
