...
<html>
	<head>
		...
		<title>Brand In Action | Casillero del Diablo</title>
	...
	<body style="background-image: url(../img/casillero-header-green.jpg)">
		...
		<div class="wrapper">
			<div class="casillero-header">
				<div class="panel-content">
					<div class="graphic-header">
						<img alt="How We Delivered 'The Best Match-Day Sponsorship Activation Ever' With a Little Help From the Devil" src="../img/casillero-header-graphic.svg">
					</div>	
				</div>	
			</div>
			<div class="casillero-1">
				<div class="panel-content">
					<img alt="The Story" src="../img/the-story.svg">
					<p>When the first Cabernet Sauvignon vines made the journey from France to Chile, no-one expected the wine they produced to be so popular.</p>
					<p>But Don Melchor de Concha Y Toro was a gifted wine-maker. A whole year’s vintage would be sold in weeks and demand became so strong each season that desperate drinkers would break into the cellar and steal whole barrels of his wine.</p>
				</div>	
			</div>
			<div class="casillero-2">
				<div class="panel-content">
					<h1>A rumour<br>becomes a<br>legend</h1>
					<p>Rather than employ additional security, Don Melchor spread a rumour – that the Devil himself lived in the cellar and would claim the soul of every wine thief.</p>
					<p>The threat of eternal burning stopped the larceny as quickly as it had begun and Don Melchor’s rumour became a persistent legend in the land.</p>
					<p>Today, the wine is known as Casillero del Diablo – the devil’s cellar – and the brand is a Manchester United sponsor.</p>
				</div>
			</div>
			<div class="casillero-3">
				<div class="panel-content">
					<h1>Bringing the brand to life</h1>
					<div class="container">
						<iframe src="http://www.youtube.com/embed/FGew3OyvI6Y?showinfo=0&modestbranding=1&autohide=1&rel=0"
						frameborder="0" allowfullscreen class="video"></iframe>
					</div>
					<p>When they approached Brand In Action to bring the brand to life at their Old Trafford match day in May 2015, we decided to create a Devil’s Cellar experience in the stadium car park.</p>
					<p>Inside a marquee, we built a replica Devil’s Cellar, complete with sound effects, vineyard aromas and an eerie projection of the devil himself.</p>
				</div>
			</div>
			<div class="casillero-4">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/cyt-1.jpg">
					</div>	
				</div>
			</div>
			<div class="casillero-4">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/cyt-2.jpg">
					</div>	
				</div>
			</div>
			<div class="casillero-5">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/cyt-3.jpg">
					</div>	
				</div>
			</div>
			<div class="casillero-6">
				<div class="panel-content">
					<div class="full-width">
						<img src="../img/cyt-4.jpg">
					</div>
				</div>
			</div>
			<div class="casillero-7">
				<div class="panel-content">
					<p>Fans received a sample of Casillero del Diablo, walked through a vineyard projection tunnel and emerged, a little nervously perhaps, into the Devil’s Cellar itself to face the truth of the legend.</p>
					<div class="full-width">
						<img src="../img/cyt-5.jpg">
					</div>	
				</div>
			</div>
			<div class="casillero-8">
				<div class="panel-content">
					<h1>Face-to-face with real legends</h1>
					<p>As it happened, they came face to face with genuine legends – including Bryan Robson, Andy Cole, Dwight Yorke and Denis Irwin – and were able to chat and have photos taken with their heroes.</p>
					<div class="full-width">
						<img src="../img/cyt-6.jpg">
					</div>	
				</div>
			</div>
			<div class="casillero-9">
				<div class="panel-content">
					<p>Around the ground, stadium branding and promotional staff directed fans to the installation.</p>
					<div class="full-width">
						<img src="../img/cyt-7.jpg">
					</div>	
				</div>
			</div>
			<div class="casillero-10">
				<div class="panel-content">
					<h1>Exceeding expectations</h1>
					<p>The Devil’s Cellar exceeded all expectations, with thousands of fans sampling the product and enjoying the experience.</p>
					<p>Manchester United’s Head of Global Partnerships commented that it was the best match day sponsorship activation to date and that it has become the benchmark for other club partners.</p>
				</div>	
			</div>
			<div class="contact-us-mobile">
				<div class="panel-content">
					<img alt="Us" src="../img/contact-us-green-wo.svg">
			...
			<div class="contact-us">
				...
				<div class="panel-content">
					<img alt="Us" src="../img/contact-us-green.svg">
					<p>We’d love to talk about ideas, events, campaigns or installations that will engage your audiences and deliver value for your sponsorship investments.</p>
					<p><strong>Brand in Action</strong><br>
					The Foundry Communications Ltd<br>
					3 Denmark Street<br>
